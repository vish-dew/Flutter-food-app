...
class _SignUpPageState extends State<SignUpPage> {
  ...
  void onSubmit(Function authenticate) {
    if (_formkey.currentState.validate()) {
      ...
      print(
          "The username: $_username, email: $_email, The password: $_password");

      authenticate(_email, _password, _username, AuthMode.SignUp)
          .then((final respones) {
